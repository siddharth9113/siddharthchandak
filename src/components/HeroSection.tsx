  ...
  return <section className="min-h-screen flex items-center pt-20 pb-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 md:pr-10 mb-10 md:mb-0 animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
          ...
          animationDelay: "0.4s"
            ...
            <div className="relative">
              ...
              <img src="/lovable-uploads/0cefa0c7-b667-4d54-90ff-78ff179a4e87.png" alt="Siddharth Chandak" className="rounded-2xl w-full h-auto shadow-lg relative z-10 object-scale-down" />
            </div>
          </div>
        </div>
      </div>
