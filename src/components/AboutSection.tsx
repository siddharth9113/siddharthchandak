      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            ...
            <p className="text-lg mb-4">Beyond my academic and professional interests, I'm a health enthusiast who loves learning more about nutrition and playing every sport under the sun. Along with this, I also thoroughly enjoy spending time in the mountains and am a rookie trekker. I enjoy having meaningful conversations especially with new folks and learn more - about ANY topic. Feel free to reach out to me and I would love to have coffee chat with you :)</p>
